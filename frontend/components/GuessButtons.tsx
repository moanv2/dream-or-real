      ...
      {choices.map((choice) => {
        ...
        return (
          <button
            ...
            className={[
              "group relative overflow-hidden rounded-[1.75rem] border px-6 py-5 text-left shadow-sm transition-all duration-300",
              disabled
                ? "cursor-default"
                : "hover:-translate-y-1 hover:border-slate-300 hover:shadow-md active:translate-y-0",
              isSelected
                ? isCorrect
          ...
          >
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                {isSelected ? (
                  <span className="rounded-full bg-white/80 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-600">
                    Your pick
                  </span>
                ) : null}
              </div>
